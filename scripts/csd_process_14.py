...
video_path  = r"input\본선_정지차량_야간_맑음_구사_20250805210500_포천방향.avi"
...
stationary_frame_count = 80  # 60프레임(약 2초) 이상 정지시 정지차로 판단
min_box_size = 15  # 정지차 판단에 사용할 최소 박스 크기 (가로+세로 평균)
